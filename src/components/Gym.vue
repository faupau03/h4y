            ...
            <div id="gym-content" class="flex mb-5">
                <div id="club-info" class="mx-5 line-clamp-4 break-words w-full">
                    ...
                    <div class="card bg-secondary bg-opacity-50 p-2">
                        <div class="w-full flex flex-wrap text-xs sm:text-base gap-2">
                            <a v-for="file in gym.files" :href="file.file" class="btn btn-sm btn-secondary p-1">
                                <DocumentIcon class="h-5 text-accent mt-0.5" />
                                {{ file.type }}
                            </a>
                            <div v-if="!gym.files || gym.files.length < 1"
                                class="btn btn-sm btn-secondary p-1 shadow-lg !text-base-content/50" disabled="true">
