    ...
    <div
        ...
        <div class="grid grid-cols-3 sm:grid-cols-6 gap-1 w-full items-center">
            ...
            <div id="date-time" class="w-fit text-xs text-gray-800">
                <span class="inline-block w-6 animate-pulse rounded xs:hidden h-3 bg-gray-500"></span>
                <div class="flex">
                    <span class="w-4 mr-1 hidden xs:block animate-pulse rounded h-3 bg-gray-500"></span>
                    <span class="w-12 animate-pulse rounded h-3 bg-gray-500"></span>
                </div>
                <div class="flex">
                    <div class="h-4 w-4 mt-0.5 animate-pulse bg-gray-500 rounded-full mr-1 shrink-0"></div>
            ...
            <div id="location" class="flex col-span-2 mt-1">
                <!-- Gymnasium -->
                <div class="h-4 w-4 bg-gray-500 animate-pulse rounded-full mr-1 shrink-0"></div>
            ...
            <div id="score" class="flex w-fit">
                <div class="min-w-[20px] mr-1 text-right">
                    <span class="w-5 animate-pulse -mb-1 h-4 inline-block rounded bg-gray-500"></span>
                </div>
                :
